...
<table width="778" border="0" align="center" cellspacing="0" cellpadding="0">
 ...
 <table width="100%" height="265"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="center" valign="top"><input name="start" type="button" class="btn_grey" onclick="window.open('servlet/StartExam?action=startExam','','width=786,height=600,scrollbars=1');" value="开始考试">
	</td>
    <td>&nbsp;</td>
  </tr>
</table> 
