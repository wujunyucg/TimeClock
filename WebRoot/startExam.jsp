...
function showStartTime(){
	var loader=new net.AjaxRequest("../servlet/StartExam?action=showStartTime&nocache="+new Date().getTime(),deal_s,onerror,"GET");
}
function showRemainTime(){
	var loader1=new net.AjaxRequest("../servlet/StartExam?action=showRemainTime&nocache="+new Date().getTime(),deal_r,onerror,"GET");
}
function onerror(){
window.close();
}
